...
def test_state_ignores_the_hidden_scratchpad_course(client: TestClient) -> None:
    with client:
        scratch = client.get("/api/v1/courses/scratchpad").json()
        assert scratch["course"]["origin"] == "scratch"
