...
class MaterialsService:
    ...
    def create_text(
        ...
        *,
        ...
        if not deduped and description is not None:
    ...
    def list_materials(
        ...
        *,
        ...
        if tag is not None:
            materials = [m for m in materials if tag in (m.tags or [])]
        return materials

    def set_tags(self, material: Material, tags: list[str]) -> Material:
        material.tags = normalize_tags(tags)
        self._session.flush()
        return material

    def set_starred(self, material: Material, starred: bool) -> Material:
        material.starred = starred
        self._session.flush()
        return material
