...
C (error-spotting), F (table fill), E (composite), G (graph reading) and D
(code execution) landed 2026-09-02/03**; **plan 50 COMPLETE (2026-09-02)** and
plan 48 landed 2026-09-01 — see the 2026-09-02 changelog entries.
