...
export function Popover({
  ...
  const floatable = resizable || movable
  ...
  const hoverProps = openOnHover
    ? {
        ...
        onMouseLeave: (event: React.MouseEvent) => {
          ...
          if (related instanceof Node && panelRef.current?.contains(related) === true) {
            return
          }
          setOpen(false)
        },
  ...
  return (
    <span className="relative inline-flex" ref={rootRef} {...hoverProps}>
      <button
        type="button"
            ...
            <div
              ...
              onMouseLeave={
                openOnHover
                  ? (event) => {
                      const related = event.relatedTarget
                      if (related instanceof Node && rootRef.current?.contains(related) === true) {
                        return
                      }
                      setOpen(false)
                    }
